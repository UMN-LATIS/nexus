...
NexusBuilder::NexusBuilder(quint32 components): chunks("cache_chunks"), scaling(0.5), useNodeTex(true),nodeTex("cache_tex") {
...
/*	static int countfile = 0;
	...
	image.save(filename.arg(countfile++)); */
